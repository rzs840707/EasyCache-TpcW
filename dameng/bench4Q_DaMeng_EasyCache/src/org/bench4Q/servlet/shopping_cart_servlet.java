...
public class shopping_cart_servlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest req, HttpServletResponse res) throws IOException,
			ServletException {
//		Database.getShoppingCart("before shopping_cart_servlet");
		Cart cart;
		String url;
		...
		// added by wangyanshi
//		System.out.println("shopping_cart_servlet() : " + SHOPPING_IDstr);
		//
//		Database.getShoppingCart("before createEmptyCart");
		int SHOPPING_ID;
...
//		Database.getShoppingCart("after createEmptyCart");
...
//		Database.getShoppingCart("before doCart");
		cart = Database.doCart(SHOPPING_ID, I_ID, ids, quantities);
//		Database.getShoppingCart("after doCart");
...
//		Database.getShoppingCart("before DisplayPromotions");
		promotional_processing.DisplayPromotions(out, req, res, SHOPPING_ID);
//		Database.getShoppingCart("after DisplayPromotions");
		...
		out.close();
//		Database.getShoppingCart("after shopping_cart_servlet");
		return;
	}
}
