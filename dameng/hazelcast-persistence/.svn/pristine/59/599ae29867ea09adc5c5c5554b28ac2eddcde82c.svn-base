...
public final class SerializationServiceImpl implements SerializationService {
    ...
    public Data toData(final Object obj) {
        ...
        try {
            ...
            Data data = null;
            if(serializer.getTypeId() == 5) {
            	data = new Data(serializer.getTypeId(), obj);
            } else {
            	serializer.write(out, obj);
            	data = new Data(serializer.getTypeId(), out.toByteArray());
            }
            // yanshi.wang over
        ...
        // attention: magic number 5 is the global serializer's type
        // return new Data(5, obj);
    }
    ...
    public Object toObject(final Data data) {
    	// yanshi.wang
    	// add {'data.getObject() == null'}
        if (data == null || data.bufferSize() == 0 && data.getObject() == null) {
            return null;
        }
        
        // localization of the key and value {yanshi.wang}
