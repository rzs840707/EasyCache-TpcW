...
public interface MapStore<K, V> extends MapLoader<K, V> {
     ...
     */
    void store(K key, V value, String table);
     ...
     */
    void storeAll(Map<K, V> map, String table);
     ...
     */
    void delete(K key, String table);
     ...
     */
    void deleteAll(Collection<K> keys, String table);
}
