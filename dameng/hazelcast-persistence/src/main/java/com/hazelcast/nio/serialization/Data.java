...
public final class Data implements IdentifiedDataSerializable {
    ...
    // yanshi.wang for local storage 
    Object object = null;
    public Data(int type, Object object) {
    	this.type = type;
//    	this.object =(HazelcastObject)(HazelcastObject.copy(object));
    	 this.object = ((HazelcastObject) object).copy();
//    	this.object = object;
    }
    
    public Object getObject() {
//    	return (HazelcastObject)(HazelcastObject.copy(object));
