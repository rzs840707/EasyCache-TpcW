...
public class NewLocalStorageTest {
	...
	public void ObjectPutTest(IMap<Integer, Person> map, Integer count) {
		...
		for(Integer i = 0; i < count; ++i) {
			...
			person.setId("1");
			person.setName("Object_Test_Object_Test_Object_Test_Object_Test_Object_Test_Object_Test");
			map.put(i, person);
		}
	...
	public void PortablePutTest(IMap<Integer, Human> map, Integer count) {
		...
		for(Integer i = 0; i < count; ++i) {
			...
			human.setId("1");
			human.setName("Object_Test_Object_Test_Object_Test_Object_Test_Object_Test_Object_Test");
			map.put(i, human);
		}
		long end = System.currentTimeMillis();
		System.gc();
	...
	public static void main(String[] args) {
		NewLocalStorageTest test = new NewLocalStorageTest();
